...
export const metadata = buildMetadata({
  title: "Project Logs",
  description:
    "A running archive of delivery notes, deployments, optimizations, and engineering milestones from Shivang Mokariya projects.",
  path: "/logs",
  keywords: ["project changelog", "engineering updates"],
  index: false,
});
...
export default function LogsPage() {
  return (
    <div
      className="flex flex-col md:flex-row bg-surface overflow-hidden relative"
    ...
    >
      ...
      <aside className="w-full md:w-72 bg-surface-container-low border-r border-outline-variant/10 p-6 overflow-y-auto">
        <Breadcrumbs items={[{ href: "/", label: "Home" }, { label: "Logs" }]} />
        <h1 className="sr-only">Project logs and engineering updates</h1>
        <div className="space-y-8">
          <div>
            <h2 className="text-xs uppercase tracking-tighter text-[#00FF41]/60 mb-4 font-headline">
              SYSTEM_METRICS
            </h2>
          ...
          <div className="bg-surface-container-highest p-4 border border-outline-variant/20">
            <h2 className="text-[10px] font-bold text-primary mb-2 tracking-widest uppercase font-headline">
              NETWORK_STATUS
            </h2>
          ...
          <div className="flex flex-col gap-2">
            <div className="h-32 w-full bg-surface-container-lowest relative overflow-hidden group">
              ...
              <Image
                ...
                alt="Illustration of infrastructure monitoring for software delivery logs"
        ...
        <div className="flex-1 overflow-y-auto p-6 font-headline bg-surface-container-lowest/30 backdrop-blur-sm">
          <div className="space-y-4 max-w-4xl">
            ...
            <div className="pt-8 flex gap-3 items-center">
              <span className="text-[#00FF41] font-bold">admin@kernel_os:~$</span>
              <span className="text-on-surface/90">tail -f activity.log</span>
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="h-[2px] bg-surface-container-highest w-full relative">
        <div className="absolute h-full bg-primary-container" style={{ width }}></div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex gap-4 group">
      ...
      <div className="flex-1">
        <span className={`${actionColor} text-xs font-bold uppercase tracking-widest`}>
          {action}
        </span>
